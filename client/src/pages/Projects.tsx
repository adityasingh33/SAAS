      ...
      <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
        ...
        <div className='flex items-center gap-2 sm:min-w-90 text-nowrap'>
          ...
          <div className='max-w-64 sm:max-w-xs'>
            <p className='text-sm text-medium captilaize truncate'>{project.name}</p>
        ...
        <div className='hidden sm:flex gap-2 bg-gray-950 p-1.5 rounded-md'>
          <SmartphoneIcon onClick={() => setDevice('phone')} className={`size-6 p-1 rounded curosr-pointer ${device === 'phone' ? "bg-gray-700" : ""}`} />

          <TabletIcon onClick={() => setDevice('tablet')} className={`size-6 p-1 rounded curosr-pointer ${device === 'phone' ? "bg-gray-700" : ""}`} />

          <LaptopIcon onClick={() => setDevice('desktop')} className={`size-6 p-1 rounded curosr-pointer ${device === 'phone' ? "bg-gray-700" : ""}`} />
        </div>
        {/* right */}
